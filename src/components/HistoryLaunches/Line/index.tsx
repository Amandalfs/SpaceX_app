...
export function Line({ date_utc, flight_number, name, rocket_name, success, webcast}: IHistory){
    return (<TableRow className="bg-slate-500">
        <TableCell>
        ...
        <TableCell>
            {
                success && <div className="flex bg-success-50 w-20 justify-center items-center p-1 text-white rounded-lg">
                    SUCESSO
                </div>
            }{
                !success && <div className="flex bg-red-600 w-20 justify-center items-center p-1 text-white rounded-lg">
                    FALHA
                </div>
            }
        </TableCell>
